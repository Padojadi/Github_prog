...
const vipLoungeMenu: Ilink[] = [
	{
		href: "/panel/vip-lounge",
		label: "Tableau de bord",
		accessPermissions: ["ACCESS_VIP_LOUNGE_MODULE"],
	},
	{
		href: "/panel/vip-lounge/lounges",
		label: "Salons VIP",
		accessPermissions: ["ACCESS_VIP_LOUNGE_MODULE"],
	},
	{
		href: "/panel/vip-lounge/bookings",
		label: "Mes réservations",
		accessPermissions: ["ACCESS_VIP_LOUNGE_MODULE"],
	},
	{
		href: "/panel/vip-lounge/access-request",
		label: "Demande d'accès",
		accessPermissions: ["ACCESS_VIP_LOUNGE_MODULE"],
	},
	{
		href: "/panel/vip-lounge/my-requests",
		label: "Mes demandes",
		accessPermissions: ["ACCESS_VIP_LOUNGE_MODULE"],
	},
	{
		href: "/panel/vip-lounge/admin",
		label: "Administration",
		accessPermissions: ["MANAGE_VIP_LOUNGE"],
	},
	{
		href: "/panel/vip-lounge/admin/booking-history",
