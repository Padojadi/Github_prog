...
import TableActionsReturned from "./table-actions-returned";
...
const TableComponentReturned: React.FC<TableComponentProps> = ({
	title,
	headers,
	data,
	actions,
...
export default TableComponentReturned;
