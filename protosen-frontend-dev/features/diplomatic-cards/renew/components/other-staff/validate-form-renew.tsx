...
const ValidateFormRenewOtherStaff = ({
	person,
	validateData,
	backLink,
	renewData,
				...
				{person?.otherStaffDCFiles ? (
					<>
						...
						<ul className="space-y-4">
							{person?.otherStaffDCFiles?.passportKey && (
							...
							{person?.otherStaffDCFiles?.adKey && (
								<li className="flex items-center gap-2">
									<div className="flex items-center">
										<CheckCircleIcon className="text-green-500 mr-2" />
							...
							{person?.otherStaffDCFiles?.othersKey && (
								<li className="flex flex-col">
									<div className="flex items-center">
										<CheckCircleIcon className="text-green-500 mr-2" />
										<span className="flex-1">
											{person?.otherStaffDCFiles?.othersKey?.length} Autre(s)
											Fichier(s)
										</span>
									</div>
...
export default ValidateFormRenewOtherStaff;
