...
const IdCardPDFDuplicata = ({
	...
	personDuplicata: IPersonCardInfosRenew;
	...
	return (
		<Document>
				...
				>
					...
					<View style={styles.header}>
						...
						>
							...
							>
								{cardTitle || personDuplicata?.type_card}
							</Text>
						</View>
						<View style={{ width: "42%" }}>
            ...
            /> */}
					...
					{(personDuplicata?.type_card || (diplomaticEntity && OIText)) && (
						...
						<View style={styles.twoColumn}>
							<View style={{ flexDirection: "column" }}>
								<View>
									...
									<Text style={styles.text}>
										{convertDate(
											deliverDate || personDuplicata?.issueDate,
											"fr",
										)}
									</Text>
								</View>
								<View>
									...
									<Text style={styles.text}>
										{convertDate(
											expirationDate || personDuplicata?.validUntil,
											"fr",
										)}
									</Text>
								</View>
...
export default IdCardPDFDuplicata;
