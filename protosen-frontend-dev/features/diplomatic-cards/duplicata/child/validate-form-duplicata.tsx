...
const ValidateFormDuplicataChild = ({
	person,
	validateData,
	backLink,
	duplicataData,
	...
	// console.log(person?.domesticAndRelativeDCFiles?.othersKey);
	return (
								...
								<li className="flex flex-col">
									<div className="flex items-center">
										...
										<span className="flex-1">
											{person?.childDCFiles?.othersKey?.length}{" "}
											Autre(s) Fichier(s)
										</span>
									</div>
...
export default ValidateFormDuplicataChild;
