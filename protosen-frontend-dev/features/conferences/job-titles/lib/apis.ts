...
export const createJobTitles = async <T>(
	data: T,
	errorMessage: string,
...
export const updateJobTitles = async <T>(
	id: unknown,
	data: T,
	errorMessage: string,
	successMessage: string,
	...
	const url = `${BACKEND_URL_CONFERENCES}/referentiels/functions/${id}`;
...
export const deleteJobTitles = async (
	id: unknown,
	errorMessage: string,
	successMessage: string,
) => {
