...
import { JobTitleDetails } from "./job-title-details";
import { deleteJobTitles } from "../lib/apis";
...
export function ActionColumn({ currentItem }: ActionColumnProps) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      const response = await deleteJobTitles(
        currentItem.id,
        "Erreur de suppression de fonction",
  ...
  return (
    <>
      ...
      <ResponsiveModal open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <ResponsiveModalContent>
          <ResponsiveModalHeader>
            <ResponsiveModalTitle>Modifier la fonction</ResponsiveModalTitle>
          </ResponsiveModalHeader>
          <JobTitleForm
      ...
      <ResponsiveModal open={isViewModalOpen} onOpenChange={setIsViewModalOpen}>
        <ResponsiveModalContent>
          <ResponsiveModalHeader>
            <ResponsiveModalTitle>Détails de la fonction</ResponsiveModalTitle>
          </ResponsiveModalHeader>
          <JobTitleDetails jobTitle={currentItem} />
        </ResponsiveModalContent>
      </ResponsiveModal>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              définitivement la fonction "{currentItem.name}".
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
