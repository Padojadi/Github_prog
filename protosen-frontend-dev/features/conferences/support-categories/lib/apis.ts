...
export const createSupportCategories = async <T>(
	data: T,
	errorMessage: string,
	...
	const url = `${BACKEND_URL_CONFERENCES}/referentiels/supports`;
...
export const updateSupportCategories = async <T>(
	id: unknown,
	data: T,
	errorMessage: string,
	successMessage: string,
	...
	const url = `${BACKEND_URL_CONFERENCES}/referentiels/supports/${id}`;
...
export const deleteSupportCategories = async (
	id: unknown,
	errorMessage: string,
	successMessage: string,
) => {
