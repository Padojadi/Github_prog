...
import { DiplomaticEntity } from "@/lib/data";
...
const IdCardFont = ({ person, settings }: { person: IPersonCardInfos, settings: SystemSettings }) => {
	const { printColor, photo, plaque, diplomaticEntity, OIText, cardTitle } =
		usePrintContext();
