...
export default async function NotFound() {
	...
	if (
		!session ||
		(session?.backendTokens && !session.backendTokens.accessToken)
	) {
		return <Main />;
	}
				...
				<div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
					<div className="max-w-2xl m-auto mt-16">
						<div className="text-center px-4">
							...
							<div className="mb-6">
								Hmm...cette page n'existe pas. Essayez de chercher autre chose !
							</div>
							<Link
								// TODO: Needs to change when conferences goes to prod
								href="/temp-home"
