			...
			>
				<div className="grid gap-4 md:grid-cols-2">
					...
					<label className="text-sm">
						...
						<select className="form-input w-full" name="automaticCheck">
							<option value="OK">OK</option>
							<option value="KO">KO</option>
						</select>
					</label>
					<label className="text-sm md:col-span-2">
						<span className="mb-1 block text-slate-700 dark:text-slate-300">Observations DPCT</span>
						<textarea required className="form-input w-full min-h-24" name="dpctNotes" />
					</label>
				</div>
