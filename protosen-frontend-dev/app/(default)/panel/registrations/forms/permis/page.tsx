			...
			>
				<div className="grid gap-4 md:grid-cols-2">
					...
					<label className="text-sm">
						...
						<input required className="form-input w-full" name="registrationNumber" />
					</label>
					<label className="text-sm">
						<span className="mb-1 block text-slate-700 dark:text-slate-300">Date attribution</span>
						<input required type="date" className="form-input w-full" name="assignedAt" />
					</label>
				</div>
				...
				{submitted && (
					<p className="mt-3 text-sm text-emerald-600 dark:text-emerald-400">
						Permis attribué (mode formulaire TDR).
					</p>
				)}
			</form>
		</div>
