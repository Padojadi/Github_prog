      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.textCenter}>
          <Text>
            ...
            <Text style={styles.link}>Consulat</Text> et à photographier/scanner
            et <Text style={styles.link}>télécharger</Text>.
          </Text>
          <Text>
            Direction des Protocoles des Conférences et de la Traduction - 2
            Place de l'Indépendance BP 404 Dakar, Sénégal
          </Text>
        </View>
      </Page>
    </Document>
