...
import { DependantsSectionDuplicata } from "@/features/diplomatic-cards/duplicata/holder/dependants-section-duplicata";
import useCurrentUser from "@/hooks/useCurrentUser";
import { markCardAsPrintedDuplicate } from "@/lib/actions/diplomaticCards/holders";
...
export default function TabLayout({
	...
	const canPreviewCard =
		(holderDuplicata?.documentStage === "accepted" ||
			holderDuplicata?.documentStage === "confirmed" ||
			holderDuplicata?.documentStage === "printed") &&
			...
			<Tabs defaultValue="requestFormfile">
				...
				<TabsContent value="requestFormfile">
					...
					<div className="flex justify-end p-5">
						<LinkButton
							...
							href={`/panel/diplomatic/holders/duplicates/${holderDuplicata?.id}/pdf/request-form-file?previousCard=${holder.id}`}
							className="mr-5"
						>
							Prévisualiser - PDF
						</LinkButton>
				...
				<TabsContent value="idcard">
					<IdCardSectionDuplicate
						person={holder}
						personDuplicate={holderDuplicata}
				...
				<TabsContent value="dependants">
					<DependantsSectionDuplicata holder={holder} />
				</TabsContent>
			</Tabs>
		</>
	);
