		...
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>Nationalité: {child?.citizenship}</Text>
				</View>
			</View>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>Carte numéro: {child?.cardNumber}</Text>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>Numéro: {child?.travellingNumber}</Text>
