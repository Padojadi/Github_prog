...
import { markCardAsPrintedDuplicate } from "@/lib/actions/diplomaticCards/childs";
...
export default function TabLayout({
	...
	const canPreviewCard =
		(childDuplicata?.documentStage === "accepted" ||
			childDuplicata?.documentStage === "confirmed" ||
			childDuplicata?.documentStage === "printed") &&
			...
			<Tabs defaultValue="requestFormfile">
				...
				<TabsContent value="requestFormfile">
					...
					<div className="flex justify-end p-5">
						<LinkButton
							...
							href={`/panel/diplomatic/childs/duplicates/${childDuplicata?.id}/pdf/request-form-file?previousCard=${child.id}`}
							className="mr-5"
						>
							Prévisualiser - PDF
						</LinkButton>
				...
				<TabsContent value="idcard">
					<IdCardSectionDuplicate
						person={child}
						personDuplicate={childDuplicata}
