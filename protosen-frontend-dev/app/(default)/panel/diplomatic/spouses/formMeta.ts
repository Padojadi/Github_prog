...
export interface ISpouseNewRequestFormMeta extends InputComponentProps {
	validation?: z.ZodType;
}

export const personalData: ISpouseNewRequestFormMeta[] = [
	{
		label: "Titulaire",
...
export const spouseData: ISpouseNewRequestFormMeta[] = [
	{
		label: "Sexe",
		name: "gender",
		validation: z.string(),
...
export const travelTitleData: ISpouseNewRequestFormMeta[] = [
	{
...
export const schemaSpouseNewRequest = z.object(validationSchema);
