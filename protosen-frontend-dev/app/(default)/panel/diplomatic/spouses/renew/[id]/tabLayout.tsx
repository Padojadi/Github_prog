...
import { markCardAsPrintedRenew } from "@/lib/actions/diplomaticCards/spouses";
...
export default function TabLayout({
	...
	const canPreviewCard =
		(spouseRenew?.documentStage === "accepted" ||
				...
				<TabsContent value="requestFormfile">
					...
					<div className="flex justify-end p-5">
						<LinkButton
							...
							href={`/panel/diplomatic/spouses/renew/${spouseRenew?.id}/pdf/request-form-file?previousCard=${spouse.id}`}
							className="mr-5"
						>
							Prévisualiser - PDF
						</LinkButton>
