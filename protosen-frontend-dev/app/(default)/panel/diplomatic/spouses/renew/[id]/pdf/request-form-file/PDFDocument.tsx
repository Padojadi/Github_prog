...
const PDFDocument = ({ spouse }: { spouse: any }) => (
	<Document>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Titre: {spouse?.title}</Text>
					<Text style={styles.textLine}>Nom: {spouse?.lastName}</Text>
					<Text style={styles.textLine}>Prénom(s): {spouse?.firstName}</Text>
					<Text style={styles.textLine}>
						Date de naissance: {convertDate(spouse?.dateOfBirth, "fr")}
					</Text>
					<Text style={styles.textLine}>
						Lieu de naissance: {spouse?.placeOfBirth}
					</Text>
					<Text style={styles.textLine}>
						Pays de naissance: {spouse?.countryOfBirth}
					</Text>
					<Text style={styles.textLine}>
						Nationalité: {spouse?.citizenship}
					</Text>
				</View>
			</View>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Rang/Grade: {spouse?.grade}</Text>
					<Text style={styles.textLine}>Fonction: {spouse?.jobFunction}</Text>
					<Text style={styles.textLine}>
						Personne remplacée: {spouse?.personReplaced}
					</Text>
					<Text style={styles.textLine}>
						Carte numéro: {spouse?.cardNumber}
					</Text>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>
						Type: {spouse?.travellingTitleType}
					</Text>
					<Text style={styles.textLine}>
						Numéro: {spouse?.travellingNumber}
					</Text>
					<Text style={styles.textLine}>Délivré à: {spouse?.deliverAt}</Text>
					<Text style={styles.textLine}>Par: {spouse?.deliverBy}</Text>
					<Text style={styles.textLine}>
						Le: {convertDate(spouse?.deliverThe, "fr")}
					</Text>
					<Text style={styles.textLine}>
						Valable jusqu'au:{" "}
						{convertDate(spouse?.travellingTitleValidUntil, "fr")}
					</Text>
				</View>
			</View>
		</Page>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>
								{convertDate(spouse?.dateArrivalSenegal, "fr")}
							</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Date de prise de fonction</Text>
							<Text style={styles.text}>
								{convertDate(spouse?.dateTakingOffice, "fr")}
							</Text>
						</View>
					</View>
				</View>
				...
				<View style={styles.section}>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>{spouse?.lastCityAbroad}</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Pays</Text>
							<Text style={styles.text} wrap>
								{spouse?.lastCountryAbroad}
							</Text>
						</View>
					</View>
					<Text style={styles.boldText}>Rue</Text>
					<Text style={styles.text}>{spouse?.lastStreetAbroad}</Text>
				</View>
