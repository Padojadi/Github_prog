...
import { markCardAsPrintedRenew } from "@/lib/actions/diplomaticCards/otherDependants";
...
export default function TabLayout({
	...
	otherDependant: any;
	otherDependantRenew: any;
}) {
	const currentUser = useCurrentUser();
	const router = useRouter();

	const canPreviewCard =
		(otherDependantRenew?.documentStage === "accepted" ||
				...
				<TabsContent value="requestFormfile">
					...
					<div className="flex justify-end p-5">
						<LinkButton
							...
							href={`/panel/diplomatic/other-dependants/renew/${otherDependantRenew?.id}/pdf/request-form-file?previousCard=${otherDependant.id}`}
							className="mr-5"
						>
							Prévisualiser - PDF
						</LinkButton>
