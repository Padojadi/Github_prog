		...
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Titre: {otherDependant?.title}</Text>
					<Text style={styles.textLine}>Nom: {otherDependant?.lastName}</Text>
					<Text style={styles.textLine}>
						Prénom(s): {otherDependant?.firstName}
					</Text>
					<Text style={styles.textLine}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>
						Rang/Grade: {otherDependant?.grade}
					</Text>
					<Text style={styles.textLine}>
						Fonction: {otherDependant?.jobFunction}
					</Text>
					<Text style={styles.textLine}>
						Personne remplacée: {otherDependant?.personReplaced}
					</Text>
					<Text style={styles.textLine}>
						Carte numéro: {otherDependant?.cardNumber}
					</Text>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>
						Délivré à: {otherDependant?.deliverAt}
					</Text>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>
								{convertDate(otherDependant?.dateArrivalSenegal, "fr")}
							</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Date de prise de fonction</Text>
							<Text style={styles.text}>
								{convertDate(otherDependant?.dateTakingOffice, "fr")}
							</Text>
						</View>
					</View>
				</View>
				...
				<View style={styles.section}>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>{otherDependant?.lastCityAbroad}</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Pays</Text>
							<Text style={styles.text} wrap>
								{otherDependant?.lastCountryAbroad}
							</Text>
						</View>
					</View>
					<Text style={styles.boldText}>Rue</Text>
					<Text style={styles.text}>{otherDependant?.lastStreetAbroad}</Text>
				</View>
