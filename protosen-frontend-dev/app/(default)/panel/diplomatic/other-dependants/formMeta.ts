...
export interface IOtherDependantNewRequestFormMeta extends InputComponentProps {
	validation?: z.ZodType;
}

export const personalData: IOtherDependantNewRequestFormMeta[] = [
	{
		label: "Titulaire",
...
export const otherDependantData: IOtherDependantNewRequestFormMeta[] = [
	{
		label: "Sexe",
		name: "gender",
		validation: z.string(),
...
export const travelTitleData: IOtherDependantNewRequestFormMeta[] = [
	{
...
export const schemaOtherDependantNewRequest = z.object(validationSchema);
