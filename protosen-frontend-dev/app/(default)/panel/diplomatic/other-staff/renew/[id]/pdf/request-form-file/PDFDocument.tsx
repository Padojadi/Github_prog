		...
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Titre: {otherStaff?.title}</Text>
					<Text style={styles.textLine}>Nom: {otherStaff?.lastName}</Text>
					<Text style={styles.textLine}>
						Prénom(s): {otherStaff?.firstName}
					</Text>
					<Text style={styles.textLine}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Rang/Grade: {otherStaff?.grade}</Text>
					<Text style={styles.textLine}>
						Fonction: {otherStaff?.jobFunction}
					</Text>
					<Text style={styles.textLine}>
						Personne remplacée: {otherStaff?.personReplaced}
					</Text>
					<Text style={styles.textLine}>
						Carte numéro: {otherStaff?.cardNumber}
					</Text>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>
						Délivré à: {otherStaff?.deliverAt}
					</Text>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>
								{convertDate(otherStaff?.dateArrivalSenegal, "fr")}
							</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Date de prise de fonction</Text>
							<Text style={styles.text}>
								{convertDate(otherStaff?.dateTakingOffice, "fr")}
							</Text>
						</View>
					</View>
				</View>
				...
				<View style={styles.section}>
					...
					<View style={styles.twoColumn}>
						<View>
							...
							<Text style={styles.text}>{otherStaff?.lastCityAbroad}</Text>
						</View>
						<View>
							<Text style={styles.boldText}>Pays</Text>
							<Text style={styles.text} wrap>
								{otherStaff?.lastCountryAbroad}
							</Text>
						</View>
					</View>
					<Text style={styles.boldText}>Rue</Text>
					<Text style={styles.text}>{otherStaff?.lastStreetAbroad}</Text>
				</View>
