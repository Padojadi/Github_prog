...
import { markCardAsPrintedRenew } from "@/lib/actions/diplomaticCards/otherStaffs";
...
export default function TabLayout({
	...
	const canPreviewCard =
		(otherStaffRenew?.documentStage === "accepted" ||
			otherStaffRenew?.documentStage === "confirmed" ||
			otherStaffRenew?.documentStage === "printed") &&
				...
				<TabsContent value="requestFormfile">
					...
					<div className="flex justify-end p-5">
						<LinkButton
							...
							href={`/panel/diplomatic/other-staff/renew/${otherStaffRenew?.id}/pdf/request-form-file?previousCard=${otherStaff.id}`}
							className="mr-5"
						>
							Prévisualiser - PDF
						</LinkButton>
