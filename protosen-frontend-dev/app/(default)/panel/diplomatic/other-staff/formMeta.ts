import { InputComponentProps } from "@/components/inputComponent";
import { getValidationSchema } from "@/components/utils/utils";

import { z } from "zod";

// extends InputComponentProps, add validation property
export interface IOtherStaffNewRequestFormMeta extends InputComponentProps {
  validation?: z.ZodType;
}

export const personalData: IOtherStaffNewRequestFormMeta[] = [
  {
    label: "Titulaire",
...
export const otherStaffData: IOtherStaffNewRequestFormMeta[] = [
  {
    label: "Sexe",
    name: "gender",
    validation: z.string(),
...
export const travelTitleData: IOtherStaffNewRequestFormMeta[] = [
  {
...
export const formSections = [
  ...
  {
    title: "Volontaires et stagiaires",
    data: otherStaffData,
  },
  {
...
export const schemaOtherStaffNewRequest = z.object(validationSchema);
