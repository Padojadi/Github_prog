...
import {
	fetchDomesticAndRelativesPrintedCardsRenew,
	undoPrintRenew,
...
export default async function Page() {
	const res = await fetchDomesticAndRelativesPrintedCardsRenew();
	...
	return (
		<div>
			<TableComponentRenew
				headers={headers}
				title="Renouvellements imprimés personnels de services, domestiques et familles"
