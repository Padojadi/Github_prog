...
import {
	createDomesticAndRelativesRenewCard,
	fetchRenewDomesticAndRelativesCards,
	getDomesticAndRelativesCardsForRenew,
} from "@/lib/actions/diplomaticCards/domesticAndRelatives";

export default async function Page() {
	const res = await fetchRenewDomesticAndRelativesCards();
	...
	return (
		<div>
			<ModalRenew
				fetchFn={getDomesticAndRelativesCardsForRenew}
				createFn={createDomesticAndRelativesRenewCard}
				key="domesticAndRelatives"
			/>
			<TableComponentRenew
				headers={headers}
