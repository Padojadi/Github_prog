		...
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					<Text style={styles.textLine}>Sexe: {domesticAndRelative?.gender}</Text>
					<Text style={styles.textLine}>Nom: {domesticAndRelative?.lastName}</Text>
					<Text style={styles.textLine}>Prénom(s): {domesticAndRelative?.firstName}</Text>
					<Text style={styles.textLine}>
						Date de naissance: {convertDate(domesticAndRelative?.dateOfBirth, "fr")}
					</Text>
					<Text style={styles.textLine}>
					...
					<Text style={styles.textLine}>
						Téléphone: {domesticAndRelative?.phone}
					</Text>
					<Text style={styles.textLine}>
						Email: {domesticAndRelative?.email}
					</Text>
				</View>
			</View>
			...
			<View style={styles.section}>
				...
				<View style={{ flexDirection: "column" }}>
					...
					<Text style={styles.textLine}>Délivré à: {domesticAndRelative?.deliverAt}</Text>
					<Text style={styles.textLine}>Par: {domesticAndRelative?.deliverBy}</Text>
					<Text style={styles.textLine}>
