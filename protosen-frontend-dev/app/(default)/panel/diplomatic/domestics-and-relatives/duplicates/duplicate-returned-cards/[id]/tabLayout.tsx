...
export default function TabLayout({
	domesticAndRelative,
	domesticAndRelativeDuplicate,
}: {
	domesticAndRelative: any;
	domesticAndRelativeDuplicate: any;
}) {
	const currentUser = useCurrentUser();
	const router = useRouter();

	const canPreviewCard =
		domesticAndRelativeDuplicate?.documentStage === "RETURNED" &&
			...
			<Tabs defaultValue="requestFormfile">
				...
				<TabsContent value="idcard">
					<IdCardSectionDuplicateReturned
						person={domesticAndRelative}
						personDuplicate={domesticAndRelativeDuplicate}
					/>
				</TabsContent>
