...
export interface IDomesticAndRelativeNewRequestFormMeta
	extends InputComponentProps {
	validation?: z.ZodType;
}

export const personalData: IDomesticAndRelativeNewRequestFormMeta[] = [
	{
		label: "Titulaire",
...
export const domesticAndRelativeData: IDomesticAndRelativeNewRequestFormMeta[] =
	[
		{
			label: "Sexe",
			name: "gender",
...
export const travelTitleData: IDomesticAndRelativeNewRequestFormMeta[] = [
	{
...
export const formSections = [
	...
	{
		title: "Père, Mère, Sœur, Frère ,Neveu, Nièce, exception",
		data: domesticAndRelativeData,
	},
	{
...
export const schemaDomesticAndRelativeNewRequest = z.object(validationSchema);
