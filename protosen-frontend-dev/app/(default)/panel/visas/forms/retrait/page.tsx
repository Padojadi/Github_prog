			...
			>
				<div className="grid gap-4 md:grid-cols-2">
					<label className="text-sm">
						<span className="mb-1 block text-slate-700 dark:text-slate-300">Numéro visa</span>
						<input required className="form-input w-full" name="visaNumber" />
					</label>
					<label className="text-sm">
					...
					<label className="text-sm md:col-span-2">
						<span className="mb-1 block text-slate-700 dark:text-slate-300">Signature</span>
						<input
							required
							className="form-input w-full"
							name="signature"
							placeholder="Nom/signature électronique du collecteur"
						/>
					</label>
				</div>
				...
				{submitted && (
					<p className="mt-3 text-sm text-emerald-600 dark:text-emerald-400">
						Retrait enregistré (mode formulaire TDR).
					</p>
				)}
			</form>
		</div>
