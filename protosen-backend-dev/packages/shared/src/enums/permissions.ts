 ...
 * @description ACCESS_VIP_LOUNGE_MODULE : Accéder au module VIP Lounge
 * @description MANAGE_VIP_LOUNGE : Gérer les salons/réservations VIP Lounge
 */
export enum UserPermission {
	...
	ACCESS_VIP_LOUNGE_MODULE = 'ACCESS_VIP_LOUNGE_MODULE',
	MANAGE_VIP_LOUNGE = 'MANAGE_VIP_LOUNGE',
}
