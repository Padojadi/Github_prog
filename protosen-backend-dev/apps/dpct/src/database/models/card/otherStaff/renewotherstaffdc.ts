...
export interface RenewOtherStaffDCAttributes {
  id: string;
...
export interface RenewOtherStaffDCCreationAttributes extends Partial<RenewOtherStaffDCAttributes> { }

// Interface avec associations pour un typage complet
export interface RenewOtherStaffDCWithAssociations extends RenewOtherStaffDCAttributes {
  previousCard?: OtherStaffDC;
}

export class RenewOtherStaffDC extends Model<InferAttributes<RenewOtherStaffDC>, InferCreationAttributes<RenewOtherStaffDC>>
  implements RenewOtherStaffDCAttributes {
  ...
  static associate(models: any) {
    RenewOtherStaffDC.belongsTo(models.OtherStaffDC, {
...
export default (sequelize: Sequelize) => {
  ...
  RenewOtherStaffDC.init(
    ...
    {
      sequelize,
      modelName: 'RenewOtherStaffDC',
      tableName: 'renewOtherStaffDCs',
    },
  );
  return RenewOtherStaffDC;
};
