...
import { OtherDependantDCFile } from './otherdependantdcfile';
...
export interface OtherDependantDCAttributes {
  id: string;
...
export interface OtherDependantDCCreationAttributes extends Partial<OtherDependantDCAttributes> {}

// Interface avec associations pour un typage complet
export interface OtherDependantDCWithAssociations extends OtherDependantDCAttributes {
  otherDependantDCFiles?: OtherDependantDCFile;
  ownerDiplomaticCard?: OwnerDiplomaticCard;
  creator?: User;
  organism?: Institution;
  renewals?: RenewOtherDependantDC[];
}

export class OtherDependantDC extends Model<InferAttributes<OtherDependantDC>, InferCreationAttributes<OtherDependantDC>>
  implements OtherDependantDCAttributes {
  ...
  // Associations
  declare otherDependantDCFiles?: OtherDependantDCFile;
  declare ownerDiplomaticCard?: OwnerDiplomaticCard;
  declare creator?: User;
  declare organism?: Institution;
  declare renewals?: RenewOtherDependantDC[];

  static associate(models: any) {
    OtherDependantDC.hasOne(models.OtherDependantDCFile, {
      foreignKey: 'otherDependantDCId',
      as: 'otherDependantDCFiles',
    });
    OtherDependantDC.belongsTo(models.OwnerDiplomaticCard, {
      foreignKey: 'ownerDiplomaticCardId',
      as: 'ownerDiplomaticCard',
    });
    OtherDependantDC.belongsTo(models.User, {
      foreignKey: 'creatorId',
      as: 'creator',
    });
    OtherDependantDC.belongsTo(models.Institution, {
      foreignKey: 'organismId',
      as: 'organism',
    });
    OtherDependantDC.hasMany(models.RenewOtherDependantDC, {
...
export default (sequelize: Sequelize) => {
  ...
  OtherDependantDC.init(
    ...
    {
      sequelize,
      modelName: 'OtherDependantDC',
      tableName: 'otherDependantDCs',
    },
  );
  return OtherDependantDC;
};
