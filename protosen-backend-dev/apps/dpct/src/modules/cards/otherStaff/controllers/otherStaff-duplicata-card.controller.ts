...
import { OtherStaffDuplicataDCService } from '../services/otherStaff-duplicata.service';
...
class OtherStaffDuplicataDCController {
	async demandDuplicataCard(req: Request<{}, {}, CreateDuplicataDCInput>, res: Response) {
		try {
			...
			const newDuplicata = await new OtherStaffDuplicataDCService().save({
	...
	async getOtherStaffsDuplicataDC(req: Request<{}, {}, {}, GetsDuplicataDCsInput>, res: Response) {
		try {
			...
			const response = await new OtherStaffDuplicataDCService().getEntities(
	...
	async getOtherStaffDuplicataDC(req: Request<GetByIdInput>, res: Response) {
		try {
			const { id } = req.params;
			const userAuth = res.locals.userAuth;

			const card = await authorizationService.getAuthorizedResource(
				new OtherStaffDuplicataDCService(),
				id,
				userAuth,
			);
	...
	async pointFocalValidation(req: Request<GetByIdInput>, res: Response) {
		try {
			...
			const card = await new OtherStaffDuplicataDCService().getOne({
				where: { id: id },
			});
			...
			const updatedDocument = await new OtherStaffDuplicataDCService().update(id, {
	...
	async adminValidation(
		...
		try {
			...
			const card = await new OtherStaffDuplicataDCService().getById(id);
			...
			const updatedDocument = await new OtherStaffDuplicataDCService().update(id, data);
	...
	async setPrintedOtherStaffDuplicataDC(
		req: Request<
			PrintOtherStaffDuplicataDCSchema['params'],
			{},
			PrintOtherStaffDuplicataDCSchema['body']
		>,
		res: Response,
	) {
		try {
			...
			new OtherStaffDuplicataDCService().validateCanPrint(card);

			const updatedCard = await new OtherStaffDuplicataDCService().update(id, {
	...
	async undoPrintOtherStaffDuplicataDC(req: Request<GetByIdInput>, res: Response) {
		try {
			const { id } = req.params;
			const userAuth = res.locals.userAuth;
			...
			new OtherStaffDuplicataDCService().validateCanUndoPrint(card);
...
export default new OtherStaffDuplicataDCController();
