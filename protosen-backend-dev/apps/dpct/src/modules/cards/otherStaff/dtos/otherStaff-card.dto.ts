...
export const createOtherStaffDCSchema = object({
	body: object({
...
export const updateOtherStaffDCSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
	body: object({
...
export const printOtherStaffDCSchema = object({
	params: object({
		id: string(),
	}).strict(),
	body: object({
...
export const otherStaffDCByIdSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
});

export const getOtherStaffsDCSchemas = object({
	query: getAllSchema.strict(),
});

export type OtherStaffDCbYIdInput = TypeOf<typeof otherStaffDCByIdSchema>['params'];
export type CreateOtherStaffDCInput = TypeOf<typeof createOtherStaffDCSchema>['body'];
export type GetOtherStaffsDCInput = TypeOf<typeof getOtherStaffsDCSchemas>['query'];
export type UpdateOtherStaffDCInput = TypeOf<typeof updateOtherStaffDCSchema>;
export type PrintOtherStaffDCSchema = TypeOf<typeof printOtherStaffDCSchema>;
