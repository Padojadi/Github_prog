...
export const createOtherDependantDCSchema = object({
	body: object({
...
export const updateOtherDependantDCSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
	body: object({
...
export const printOtherDependantDCSchema = object({
	params: object({
		id: string(),
	}).strict(),
	body: object({
...
export const otherDependantDCByIdSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
});

export const getOtherDependantsDCSchemas = object({
	query: getAllSchema.strict(),
});

export type OtherDependantDCbYIdInput = TypeOf<typeof otherDependantDCByIdSchema>['params'];

export type CreateOtherDependantDCInput = TypeOf<typeof createOtherDependantDCSchema>['body'];

export type GetOtherDependantsDCInput = TypeOf<typeof getOtherDependantsDCSchemas>['query'];

export type UpdateOtherDependantDCInput = TypeOf<typeof updateOtherDependantDCSchema>;

export type PrintOtherDependantDCSchema = TypeOf<typeof printOtherDependantDCSchema>;
