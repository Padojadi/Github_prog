...
export const createSpouseDCSchema = object({
	body: object({
...
export const updateSpouseDCSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
	body: object({
...
export const spouseDCByIdSchema = object({
	params: object({
		id: string().uuid(),
	}).strict(),
});

export const getSpousesDCSchemas = object({
	query: getAllSchema.strict(),
});

export const printSpouseDCSchema = object({
	params: object({
		id: string(),
	}).strict(),
	body: object({
...
export type SpouseDCbYIdInput = TypeOf<typeof spouseDCByIdSchema>['params'];

export type CreateSpouseDCInput = TypeOf<typeof createSpouseDCSchema>['body'];

export type GetSpousesDCInput = TypeOf<typeof getSpousesDCSchemas>['query'];

export type UpdateSpouseDCInput = TypeOf<typeof updateSpouseDCSchema>;

export type PrintSpouseDCSchema = TypeOf<typeof printSpouseDCSchema>;
