...
import { SpouseDuplicataDCService } from '../services/spouse-duplicata.service';
import { SpouseDCService } from '../services/spouse-card.service';
import { RenewSpouseDCService } from '../services/spouse-renew.service';
...
class SpouseDuplicataDCController {
	async demandDuplicataCard(req: Request<{}, {}, CreateDuplicataDCInput>, res: Response) {
		try {
			...
			const newDuplicata = await new SpouseDuplicataDCService().save({
	...
	async getSpousesDuplicataDC(req: Request<{}, {}, {}, GetsDuplicataDCsInput>, res: Response) {
		try {
			...
			const response = await new SpouseDuplicataDCService().getEntities(
	...
	async pointFocalValidation(req: Request<GetByIdInput>, res: Response) {
		try {
			...
			const card = await new SpouseDuplicataDCService().getOne({
				where: { id: id },
			});
			...
			const updatedDocument = await new SpouseDuplicataDCService().update(id, {
	...
	async adminValidation(
		...
		try {
			...
			const card = await new SpouseDuplicataDCService().getById(id);
			...
			const updatedDocument = await new SpouseDuplicataDCService().update(id, data);
	...
	async setPrintedSpouseDuplicataDC(
		req: Request<PrintSpouseDuplicataDCSchema['params'], {}, PrintSpouseDuplicataDCSchema['body']>,
		res: Response,
	) {
		try {
			const { id } = req.params;
			...
			new SpouseDuplicataDCService().validateCanPrint(card);

			const updatedCard = await new SpouseDuplicataDCService().update(id, {
	...
	async undoPrintSpouseDuplicataDC(req: Request<GetByIdInput>, res: Response) {
		try {
			const { id } = req.params;
			const userAuth = res.locals.userAuth;
			...
			new SpouseDuplicataDCService().validateCanUndoPrint(card);
...
export default new SpouseDuplicataDCController();
