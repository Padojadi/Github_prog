...
export const printDomesticAndRelativeDuplicataDCSchema = object({
	params: object({
		id: string().uuid(),
	}),
	body: object({
...
export type PrintDomesticAndRelativeDuplicataDCSchema = TypeOf<
	typeof printDomesticAndRelativeDuplicataDCSchema
>;
