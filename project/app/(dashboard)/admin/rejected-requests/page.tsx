...
export default function RejectedRequestsPage() {
  ...
  const loadRequests = async () => {
    try {
      ...
      toast.error('Erreur lors du chargement des demandes rejetées')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Demandes Rejetées</h1>
          <p className="text-muted-foreground mt-1">
            Toutes les demandes d'accès qui ont été refusées
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                {filteredRequests.length} demande(s) rejetée(s)
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          ...
          {filteredRequests.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p>Aucune demande rejetée trouvée</p>
            </div>
          ) : (
                        ...
                        <div className="space-y-3 flex-1">
                          ...
                          {request.processed_at && (
                            <p className="text-xs text-muted-foreground">
                              Rejeté le {format(new Date(request.processed_at), 'dd MMM yyyy à HH:mm', { locale: fr })}
                            </p>
                          )}
                          ...
                          {request.admin_notes && (
                            <div className="bg-red-50 border border-red-200 p-3 rounded-lg text-sm">
                              ...
                              <p className="text-red-800">{request.admin_notes}</p>
                            </div>
                          )}
                        </div>
      ...
      <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Détails de la demande rejetée</DialogTitle>
            <DialogDescription>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 border-2 border-red-200 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-red-700">Demande Rejetée</span>
                </div>
              ...
              <div className="space-y-2">
                <h4 className="font-semibold">Informations de visite demandée</h4>
                <div className="bg-muted p-3 rounded-lg space-y-1 text-sm">
              ...
              {selectedRequest.admin_notes && (
                <div className="space-y-2">
                  <h4 className="font-semibold">Raison du rejet</h4>
